            ...
            <div class="h-100 d-flex flex-column justify-content-center align-items-center gap-lg-5" id="home-banner-img">
                <div class="h-100" style="position: absolute; top: 0; left: 0;">
                    <div class="m-3 d-flex flex-column justify-content-around" style="height: 90%;">
                        <div class="d-flex">
                            ...
                            <div class="" style="margin-left: -10px;">
                                <div class="bg-secondary d-flex justify-content-center align-items-center" style="height: 45px; width: 45px; border-radius: 50%;">
                                    <p class="text-primary p-1 fw-extrabold m-0">18K+</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <h2 class="d-sm-none fw-bold display-4 fw-extrabold text-custom-dark-blue" aria-hidden="true">FUEL UP YOUR DAY WITH OUR PLATTER!</h2>
                        <div>
